...
const HeroCard = () => {
  return (
    <section className=' flex flex-col items-center '>
        ...
        <button className='bg-primary  rounded-md p-2 mt-6 border dark:bg-dark-primary dark:text-dark-on-primary bg-light-primary-container text-light-on-primary border-light-primary '>Get Started</button>
