...
const HeroCard = () => {
  return (
    <section className=' flex flex-col items-center'>
        ...
        <button className='bg-primary text-white rounded-md p-2 mt-6 border dark:bg-dark-primary dark:text-dark-on-primary border-light-primary '>Get Started</button>
