...
export default function RootLayout({
  ...
  return (
    ...
    <Container>
      ...
      <body className= {`${inter.className}  flex flex-col mx-auto bg-opacity-15 dark:bg-opacity-100  bg-light-beige  text-dark-orange dark:text-white dark:text-opacity-80`} >
